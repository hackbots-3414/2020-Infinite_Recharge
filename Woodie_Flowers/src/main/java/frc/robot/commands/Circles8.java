...
// Called when the command is initially scheduled.
  ...
  public void initialize() {
    System.out.println("Intializing......Running Circles8.........");
    running = true;
  ...
  private void shutDownInAuton(){
    ...
    System.out.println("ShutDownInAuton(Circles8) EXIT..............");
  ...
  public void end(boolean interrupted) {
    System.out.println("End(Circles8).................");
    running = false;
  }
  ...
  public boolean isFinished() {
    System.out.println("IsFinished Circles8................");
    return !running;
  }
}

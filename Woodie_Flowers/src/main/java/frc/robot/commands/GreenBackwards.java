...
public class GreenBackwards extends CommandBase {
  ...
  public GreenBackwards(DrivetrainSubsystem drive) {
...
// Called when the command is initially scheduled.
  ...
  public void initialize() {
    System.out.println("Intializing......Running GREENBACKWARDS.........");
    running = true;
  ...
  @Override
  public void execute() {
    System.out.println("Enter Execute GREENBACKWARDS...............");    
      //running = true;
    long SinceHowLongRunning = System.currentTimeMillis() - startTime;

    if (!running || (DURRATION_IN_MILLISECONDS <= SinceHowLongRunning)){
      System.out.println("Shutting Down GREENBACKWARDS................");
      shutDownInAuton(); 
      running = false;
      drivetrainSubsystem.drive(0,0);
    } else {
      System.out.println("Running GREENBACKWARDS......................");
  ...
  private void shutDownInAuton(){
    ...
    System.out.println("ShutDownInAuton(GREENBACKWARDS) EXIT..............");
  ...
  public void end(boolean interrupted) {
    System.out.println("End(GREENBACKWARDS).................");
    running = false;
  }
  ...
  public boolean isFinished() {
    System.out.println("IsFinished GREENBACKWARDS................");
    return !running;
  }
}
